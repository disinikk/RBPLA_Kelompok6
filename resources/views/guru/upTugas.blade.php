            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                ...
                <p class="mt-4 text-lg text-gray-300">
                    Tambahkan Tugas Sesuai Mata Pelajaran Untuk Kemudian Dikerjakan Oleh Anak
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container mx-auto px-16">
        <form action="/tugas/upload" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 pt-0">
                ...
                <input type="datetime-local" id="deadline" name="deadline" required="required" class="form-control px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none"/>
            </div>
