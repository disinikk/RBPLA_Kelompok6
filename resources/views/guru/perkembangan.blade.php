                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($perkembangan as $p)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="/perkembangan/read/{{ $p->id }}" class="text-indigo-600 hover:text-indigo-900">Detail</a>
                                |
                                <a href="/perkembangan/hapus/{{ $p->id }}" class="text-indigo-600 hover:text-indigo-900">Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
