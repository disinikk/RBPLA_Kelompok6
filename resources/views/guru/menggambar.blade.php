  ...
  <body class="text-gray-800 antialiased">
    <x-app-layout>
      ...
      <div class="container mx-auto px-16">
        ...
        <a href="/menggambar/tambahmenggambar">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($materi as $m)
                            <tr>
                                ...
                                <a href="/menggambar/read/{{ $m->id }}" class="text-indigo-600 hover:text-indigo-900">Detail</a>
                                |
                                <a href="/menggambar/hapus/{{ $m->id }}" class="text-indigo-600 hover:text-indigo-900">Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
