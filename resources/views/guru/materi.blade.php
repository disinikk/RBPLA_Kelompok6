                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($materi as $m)
                            <tr>
                                ...
                                <a href="/materi/read/{{ $m->id }}" class="text-indigo-600 hover:text-indigo-900">Detail</a>
                                |
                                <a href="/materi/hapus/{{ $m->id }}" class="text-indigo-600 hover:text-indigo-900">Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
